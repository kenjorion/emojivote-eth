...
module.exports = {
  ...
  networks: {
    localhost: {
      url: 'https://kovan.infura.io/v3/2717afb6bf164045b5d5468031b93f87',
      //url: 'http://localhost:8545',
      accounts: {
        mnemonic: "mechanic earth wreck barely picnic island hope update tomato review actual glance"
      },
    },
  },
  solc: {
