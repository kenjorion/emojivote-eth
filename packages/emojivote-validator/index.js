...
const SPREADSHEET_ID = '1mxFJN8ReLIS43KhQvHMlHp5BSCD7mQ7lGiDB8XKOHDU'

const OUTPUT_FILE = "../react-app/src/validVotes.json";
const ERC20_ABI = [{"constant": true,"inputs": [{"name": "_owner","type": "address"}],"name": "balanceOf","outputs": [{"name": "balance","type": "uint256"}],"payable": false,"type": "function"}]
const ERC20_TOKEN_ADDRESS = "0x888d7fda19b9b52009e20595e8be63e929536ff7"
const mainnetProvider = new ethers.providers.InfuraProvider("mainnet","2717afb6bf164045b5d5468031b93f87")
const kovanProvider = new ethers.providers.InfuraProvider("kovan","2717afb6bf164045b5d5468031b93f87")
const tokenContract = new Contract(ERC20_TOKEN_ADDRESS, ERC20_ABI, kovanProvider);
    ...
    sheets.spreadsheets.values.get({
      ...
      if (rows.length) {
        for(let r in rows) {
          ...
          const rowone = row[0]
          console.log(recovered + " la  et " + rowone);
          ...
          if(recovered===row[0]){
            ...
            console.log("💰 Balance of "+validAddress+" is " + balance );
...
function authorize(credentials, callback) {
  console.log(credentials.installed.client_secret);
