import { IHostConfig, TAllEventTypes, TEventListenerDict, WidgetVariantTypes } from './types';
...
export declare function determineWidgetVariant(config: IHostConfig): WidgetVariantTypes;
