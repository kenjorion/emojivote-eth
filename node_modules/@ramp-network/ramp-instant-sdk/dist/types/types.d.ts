...
declare type TPurchaseID = number;
...
export declare type TWidgetEvents = IWidgetCloseEvent | IWidgetConfigDoneEvent | IPurchaseCreatedEvent | IPurchaseFailedEvent | IPurchaseSuccessfulEvent;
...
export declare type WidgetVariantTypes = 'desktop' | 'mobile';
