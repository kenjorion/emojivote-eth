...
var RampInstantSDK = /** @class */ (function () {
    function RampInstantSDK(config) {
        ...
        this._config = __assign({}, temporaryConfig, { variant: widgetVariant, widgetInstanceId: utils_1.getRandomIntString() });
        this._widgetIframeUrl = init_helpers_1.initWidgetIframeUrl(this._config);
        this._registerSdkEventHandlers();
        window.addEventListener('message', this._subscribeToWidgetEvents);
        this.domNodes = init_helpers_1.initDOMNode(this._widgetIframeUrl, this._dispatchEvent, this._config);
    }
    ...
    RampInstantSDK.prototype._registerSdkEventHandlers = function () {
        ...
        this._on(types_1.WidgetEventTypes.WIDGET_CONFIG_DONE, function (_event) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        // tslint:disable-next-line:no-magic-numbers
                        _b.sent();
                        return [4 /*yield*/, event_polling_1.doFetchPurchase(apiUrl, purchaseId, token)];
                    case 3:
                        purchase = _b.sent();
                        if (!purchase) {
                            return [3 /*break*/, 1];
